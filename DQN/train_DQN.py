...
class DQNAgent:
    def __init__(self, batch_size, num_edges, list_demands):
        ...
        self.bw_allocated_feature = np.zeros((num_edges,len(list_demands)))
...
if __name__ == "__main__":
    ...
    agent = DQNAgent(batch_size, env_training.numEdges, env_training.listofDemands)
